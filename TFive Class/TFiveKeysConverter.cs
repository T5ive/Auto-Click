...
{
    public class TFiveKeysConverter
    {
        public static string Convert(Keys keys)
        {
            if (keys != Keys.Control || keys != Keys.Alt)
            {
                return ConvertModifiers(keys);
            }

            switch (keys)
            {
                case Keys.Control when keys != Keys.Alt:
                    return ConvertModifiers(Keys.Control) + " + " + ConvertKeyPart(keys);
                case Keys.Control when keys == Keys.Alt:
                    return ConvertModifiers(Keys.Control) + " + " + ConvertKeyPart(Keys.Alt) + " + " + ConvertKeyPart(keys);
                default:
